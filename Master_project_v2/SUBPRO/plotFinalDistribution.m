function [ hFig ] = ...
    plotFinalDistribution( psi_struct, fontProps, colorMatrix, flag )
global xi Rmax

greekmu = char(956);

psi_end = psi_struct.psi_end/Rmax;
psi0_mat = psi_struct.psi0_mat/Rmax;
psimax = psi_struct.psimax/Rmax;
